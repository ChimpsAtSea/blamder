...
enum HaloGen3TestOption {
  BUMP_MAPPING_OFF = 0,
  BUMP_MAPPING_STANDARD = 1,
  BUMP_MAPPING_DETAIL = 2,
  BUMP_MAPPING_DETAIL_BLEND = 2,
};
...
class HaloGen3Node : public BsdfNode {
 public:
  ...
  NODE_SOCKET_API(float, subsurface_anisotropy)
  NODE_SOCKET_API(ClosureType, method)
  NODE_SOCKET_API(HaloGen3AlbedoOption, albedo_option)
  NODE_SOCKET_API(HaloGen3TestOption, bump_mapping_option)
};
