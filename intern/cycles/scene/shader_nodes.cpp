...
NODE_DEFINE(HaloGen3Node)
{
  ...
  albedo_mode_enum.insert("Four Change Color (Applying to Specular)",
                          ALBEDO_OPTION_FOUR_CHANGE_COLOR_APPLYING_TO_SPECULAR);
  ...
  /* halo gen3 shader albedo */
  static NodeEnum bump_mapping_option_enum;
  bump_mapping_option_enum.insert("Off", BUMP_MAPPING_OFF);
  bump_mapping_option_enum.insert("Standard", BUMP_MAPPING_STANDARD);
  bump_mapping_option_enum.insert("Detail", BUMP_MAPPING_DETAIL);
  bump_mapping_option_enum.insert("Detail Blend", BUMP_MAPPING_DETAIL_BLEND);
  SOCKET_ENUM(bump_mapping_option, "Bump Mapping", bump_mapping_option_enum, BUMP_MAPPING_OFF);
